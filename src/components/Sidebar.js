...
const Sidebar = () => {
    ...
    const {showSidebar, closeSidebar, likedList, englishLang, toggleLanguage, theme, themeToggleButton} = useGlobalContext();
