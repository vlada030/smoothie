...
const History = () => {
    ...
    return <section className='section about-section'>
                ...
                <p>
                    In 1973, Steve Kuhnau founded the first Smoothie King in Louisiana. Kuhnau, who had been experimenting with smoothie recipes for years, added ingredients such as yogurt, protein powder and vitamins to his smoothies. Over the next three decades, Smoothie King smoothie bars spread across the country and made the term "smoothie" a household word. At the same time, smoothies were becoming available in more restaurants, juice bars and health food stores. Soon, pre-bottled smoothies, made by companies like Naked Juice and Odwalla, appeared in grocery stores. Today, smoothies of every flavor and variety are easy to find, no matter where you live. In addition, many websites and books offer recipes for home-made smoothies.
                </p>
                <p>
